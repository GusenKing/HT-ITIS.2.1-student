...
public class IntegrationCalculatorControllerTests : IClassFixture<WebApplicationFactory<Hw11.Program>>
{
    private readonly HttpClient _client;

    public IntegrationCalculatorControllerTests(WebApplicationFactory<Hw11.Program> fixture)
    {
    ...
    [InlineData("((10 + 6) - 9(", MathErrorMessager.IncorrectBracketsNumber)]
    [InlineData("((10 + 6) - (9", MathErrorMessager.IncorrectBracketsNumber)]
